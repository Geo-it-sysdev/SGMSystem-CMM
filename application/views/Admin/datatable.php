                                     ...
                                     <div class="listjs-table" id="customerList">
                                         <div class="row g-4 mb-3">
                                             <div class="col-sm-auto">
                                                 <div>
                                                     <button type="button" class="btn btn-success add-btn me-2" data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal"><i class="ri-add-line align-bottom me-1"></i> Add </button>
                                         ...
                                         <div class="table-responsive table-card mt-3 mb-1">
                                             <table class="table align-middle table-nowrap" id="customerTable">
                                                 ...
                                                 <tbody class="list form-check-all">
                                                     <tr>
                                                         ...
                                                         <td class="status">
                                                            <span class="badge bg-success-subtle text-success " style="font-size: 14px;">Active</span>
                                                            </td>
                                                         <td>
                                             ...
                                             <div class="noresult" style="display: none">
                                                 ...
                                                 <lord-icon
                                                     ...
                                                     <!-- <p class="text-muted mb-0">We've searched more than 150+ Orders We did not ____ any orders for you ______. </p> -->
                                                 </div>
                                             </div>
                                         </div>
                                 ...
                                 <form class="tablelist-form" autocomplete="off">
                                     <div class="modal-body">
                                         ...
                                         <div class="mb-3">
                                             ...
                                             <div class="invalid-feedback">Please enter a customer ____. </div>
                                         </div>
